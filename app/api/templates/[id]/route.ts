import { NextRequest, NextResponse } from "next/server"; // Changed Request to NextRequest to match Next.js types
...
export async function PATCH(
  ...
  const { id } = await params; // This is now correctly typed
